...
const LadiesGrid = () => {
  ...
  const ladiesProducts = products.filter((p) => p.gender === "ladies");
  const visibleProducts = ladiesProducts.slice(0, visibleCount);
  const isAllLoaded = visibleCount >= ladiesProducts.length;

  console.log("Total Ladies Products:", ladiesProducts.length);
